...
const timeMonth = ref([ "2020-01-20T05:40:59.413Z", "2024-01-20T05:41:00.177Z"])
...
const updateChartInfo = async () => {
  ...
  if (timeSelect.value === 'year') {
    const { startYear, startMonth, endYear, endMonth } = extractYearMonth(timeYear.value);
